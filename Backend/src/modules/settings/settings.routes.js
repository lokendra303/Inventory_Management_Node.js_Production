...
router.get('/exchange-rates/live',           extractInstitutionContext, settingsController.getLiveRate);
router.post('/exchange-rates/live-sync',     extractInstitutionContext, auditLog('live_rates_synced'), settingsController.syncAllLiveRates);
