...
module.exports = {
  ...
  createUpgradeRequest:      wrap(req => svc.createUpgradeRequest(req.institutionId, req.body)),
  listMyUpgradeRequests:     wrap(req => svc.listMyUpgradeRequests(req.institutionId)),
