...
-- NOTE: OTPs are stored in plaintext (`otp_code`) for now â€” protect DB access.
--
...
-- us nothing. The monotonic id doubles as the "latest OTP" marker â€”
...
-- an AUTO_INCREMENT id doubles as a monotonic "latest OTP" marker â€” no
...
CREATE TABLE IF NOT EXISTS item_variant_attributes (
 ...
 -- =============================================================================
-- SKU Auto-Generator (Zoho-style) â€” per-institution rules with category overrides
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS sku_generator_rules (
  ...
  -- `separator` is a reserved word in MySQL (GROUP_CONCAT) â€” keep it backticked.
...
--     â””â”€â”€ warehouse_racks   (e.g. "R-01", "R-02")
--           â””â”€â”€ warehouse_bins (smallest storage unit, optionally barcoded)
--
...
-- 4. items.default_bin_id â€” preferred putaway bin for an item.
