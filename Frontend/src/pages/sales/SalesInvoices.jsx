...
import { FileTextOutlined, PlusOutlined, EyeOutlined, FilePdfOutlined, EditOutlined, PrinterOutlined } from '@ant-design/icons';
...
const SalesInvoices = () => {
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <Modal
        title={`${modalMode === 'create' ? 'Create' : 'Edit'} Sales Invoice`}
